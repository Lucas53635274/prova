...
function cadstime(){
    ...
    let modalidade = prompt("Digite a modalidade que quer fazer: ")
    ...
    mostraHTML.innerHTML += `<p class="textos">Modalidade: ${modalidade.toUpperCase()}`
    mostraHTML.innerHTML += `<p class="textos">${aluno1}, ${idade1}</p>`;
    mostraHTML.innerHTML += `<p class="textos">${aluno2}, ${idade2}</p>`;
    mostraHTML.innerHTML += `<p class="textos">${aluno3}, ${idade3}</p>`;   
}
